...
Map<String, Map<String, String>> gAllSupportLanguage = {
  "en": {
    ...
    "韩语": "Korean",
    "language_desc":
        "If the translation is wrong, please contact me by email. Thank you very much for your support and understanding!",
    "send": "Send out"
  },
  "zh": {
    'light_mode':'浅色模式',
  ...
  "cht": {
    ...
    "tip": "溫馨提示",
    "limit_project_name_length": "項目名稱不能超過15個字元",
    ...
    "意大利语": "義大利語",
    "韩语": "韓語",
    "language_desc": "如果有內容翻譯不對，請發郵件聯系我，非常感謝您的支持和理解！",
    "send": "發送"
  },
  "jp": {
    "theme": "テーマスタイル",
    ...
    "tip": "お知らせ",
    "limit_project_name_length": "プロジェクト名は15文字以内",
    ...
    "意大利语": "イタリア語",
    "韩语": "韓国語",
    "language_desc": "もし内容の翻訳が間違っていたら、メールで連絡してください。ご支持と理解に感謝します。",
    "send": "送信"
  },
  "spa": {
    ...
    "韩语": "Coreano",
    "language_desc":
        "¡Si hay alguna traducción incorrecta del contenido, por favor envíeme un correo electrónico, muchas gracias por su apoyo y comprensión!",
    "send": "Enviar"
  },
  "fra": {
    ...
    "韩语": "Coréen",
    "language_desc":
        "S'il y a des erreurs dans la traduction du contenu, s'il vous plaît envoyez - moi un e - mail, merci beaucoup pour votre soutien et votre compréhension!",
    "send": "Envoyer"
  },
  "de": {
    ...
    "韩语": "Koreanisch",
    "language_desc":
        "Wenn die Übersetzung falsch ist, kontaktieren Sie mich bitte per E-Mail. Vielen Dank für Ihre Unterstützung und Verständnis!",
    "send": "Senden Sie"
  },
  "it": {
    "theme": "Stile di tema",
    ...
    "韩语": "Coreano",
    "language_desc":
        "Se la traduzione è sbagliata, si prega di contattarmi via e-mail. Grazie mille per il vostro supporto e comprensione!",
    "send": "Inviare fuori"
  },
  "kor": {
    "theme": "주제 스타일",
    ...
    "tip": "따뜻한 힌트",
    "limit_project_name_length": "프로젝트 이름은 15자를 초과할 수 없습니다.",
    ...
    "意大利语": "이탈리아어",
    "韩语": "한국어 공부 해요.",
    "language_desc": "만약 내용 번역이 잘못되면 메일로 저에게 연락 주십시오. 당신의 지지와 이해에 매우 감사드립니다.",
    "send": "보내다"
  }
};
